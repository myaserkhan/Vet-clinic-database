...
```
  git clone git@github.com:myaserkhan/Vet-Clinic-Database.git
  cd Vet-Clinic-Database
```

### Creating a database <a name="create-a-database"></a>
...
- Twitter: [@khanyaser007](https://twitter.com/https://twitter.com/khanyaser007)
